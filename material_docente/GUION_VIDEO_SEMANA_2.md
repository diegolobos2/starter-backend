...
3. Mostrar la duplicación documental: la misma frase de RET-001 repetida
   textual en `docs/contrato/reglas.md` y `docs/contrato/alcance.md`. "Dos fuentes
   de verdad para lo mismo: si edito una y no la otra, quedan
   desincronizadas."
4. Mostrar `docs/contrato/trazabilidad.md` viejo → estructura desordenada,
...
Apoyarse en `docs/teoria/frontera_core_application.md`. No leerlo entero;
...
2. La tabla de responsabilidades (quién pregunta / quién tiene efectos /
   quién sabe de negocio). Mostrarla desde `docs/contrato/arquitectura.md`.
...
- Abrir `docs/diagramas/estados_retencion.md` y mostrar el diagrama Mermaid ya
  incluido.
